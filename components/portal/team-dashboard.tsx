...
function DashboardCalendar({ teamId, canAddEvents }: { teamId?: string; canAddEvents: boolean }) {
      ...
      <CardContent>
        <div className="space-y-3">
              ...
              if (canAddEvents) {
                return (
                  <button
                    ...
                    className={cellClass}
                    style={cellStyle}
                    aria-label={`Add or view events for ${format(day, "MMMM d, yyyy")}`}
                  >
                    <div
          ...
          {canAddEvents && quickAddDate && (
            <Dialog open={quickAddOpen} onOpenChange={(o) => { setQuickAddOpen(o); if (!o) setQuickAddDate(null) }}>
              <DialogContent className="max-w-md">
                ...
                <div className="space-y-3">
                  <div className="space-y-1.5">
                    <Label htmlFor="qa-title" style={{ color: "rgb(var(--text))" }}>Title *</Label>
                    <Input
                      id="qa-title"
                      value={qaTitle}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      <Label htmlFor="qa-type" style={{ color: "rgb(var(--text))" }}>Type</Label>
                      <select
                        id="qa-type"
                        value={qaType}
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="qa-audience" style={{ color: "rgb(var(--text))" }}>Who sees it</Label>
                      <select
                        id="qa-audience"
                        value={qaAudience}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      <Label htmlFor="qa-start" style={{ color: "rgb(var(--text))" }}>Start</Label>
                      <Input
                        id="qa-start"
                        type="time"
                        value={qaStartTime}
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="qa-end" style={{ color: "rgb(var(--text))" }}>End</Label>
                      <Input
                        id="qa-end"
                        type="time"
                        value={qaEndTime}
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="qa-loc" style={{ color: "rgb(var(--text))" }}>Location</Label>
                    <Input
                      id="qa-loc"
                      value={qaLocation}
...
export function TeamDashboard({ session }: TeamDashboardProps) {
  ...
  const canAddCalendarEvents =
    roleUpper === "HEAD_COACH" || roleUpper === "ASSISTANT_COACH"
  ...
  return (
    <div className="space-y-4 pb-6">
      ...
      {hasTeam && (
        <DashboardCalendar teamId={user.teamId} canAddEvents={canAddCalendarEvents} />
      )}
