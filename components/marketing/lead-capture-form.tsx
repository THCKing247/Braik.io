  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div className="space-y-2">
          <Label htmlFor="lead-school" className="text-sm font-medium text-slate-900">
            School / Program
          </Label>
          <Input
            id="lead-school"
      ...
      <div className="space-y-2">
        <Label htmlFor="lead-role" className="text-sm font-medium text-slate-900">
          Primary Role
        </Label>
        <select
          id="lead-role"
          ...
          className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#3B82F6]"
        >
      ...
      <div className="space-y-2">
        <Label htmlFor="lead-message" className="text-sm font-medium text-slate-900">
          Message
        </Label>
        <textarea
          id="lead-message"
          ...
          className="min-h-[120px] w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-[#3B82F6]"
        />
      </div>
