...
const KEY_LABELS: Partial<Record<PlatformPermissionKey, string>> = {
  ...
  message_players: "Message players",
...
const SECTION_KEYS: Record<string, PlatformPermissionKey[]> = {
  ...
  Rosters: ["view_roster", "create_players", "edit_players", "delete_players", "import_roster", "export_roster"],
  ...
  "Reports / Documents": ["view_reports", "upload_documents", "manage_documents", "export_reports"],
  "Billing / Subscription": ["view_billing", "manage_billing"],
  "Athletic Director / Coach Views": ["view_ad_dashboard", "coach_view_access", "manage_team_settings", "manage_program_settings"],
}
