  ...
  return (
    <section className="space-y-2.5">
      <div className="rounded-2xl border border-white/10 bg-white/5 px-3 py-2.5 backdrop-blur-md">
        ...
        <div className="mt-1 flex items-center justify-between gap-2">
          <div className="min-w-0">
            <p className="truncate text-[15px] font-black text-white">Hey {firstName}</p>
            <p className="truncate text-[11px] font-medium text-white/70">
              {teamName}
              {sport?.trim() ? ` · ${sport}` : ""}
            </p>
          </div>
          <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-sky-500 via-amber-400 to-orange-600 text-xs font-black text-white">
            B
          </div>
        </div>
      </div>
      ...
      <Link
        ...
        prefetch={false}
        className="group flex items-center gap-2.5 rounded-2xl border border-sky-400/25 bg-black/30 px-3 py-2.5 shadow-inner backdrop-blur-md transition active:scale-[0.99]"
      >
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-[11px] font-medium text-white/55">Home · Gates open 5:30 · mock schedule</p>
        </div>
