...
import { MarketingHeroCtaRow } from "@/components/marketing/marketing-hero-cta-row"
import { MarketingFinalShatterCta } from "@/components/marketing/marketing-final-shatter-cta"
import { MarketingPricingViewTracker } from "@/components/marketing/marketing-pricing-view-tracker"
...
const LeadCaptureFormLazy = dynamic(
  () => import("@/components/marketing/lead-capture-form").then((m) => m.LeadCaptureForm),
  {
    loading: () => (
      <div
        className="min-h-[280px] w-full rounded-xl bg-[#1f2937]/40 animate-pulse"
        aria-hidden
      />
    ),
  }
...
/** Marketing homepage (desktop lg+); server-rendered shell with small client islands. */
export function MarketingHomeView() {
  return (
    ...
    <div className="hidden min-h-screen bg-white lg:block">
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-2 md:order-1 flex justify-center md:justify-start">
                  <Image
                    ...
                    style={{ maxHeight: "min(1500px, 90vh)" }}
      ...
      <MarketingPricingViewTracker className="relative py-40 bg-[#F9FAFB]">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <ScrollReveal>
              <div className="space-y-8">
